...
def functions(func):
    ...
    if func == "help":
        ...
        print('in development')
        return False
        chat.ask('throughout the session, i will give you a series of multiple-choice questions. you will respond with the answer only, no description. do you understand?')
        message=get_input()
        ...
        cprint("Function does not exist, --help for info", "white", "on_red", attrs=["bold"])
        return False
